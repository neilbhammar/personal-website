...
const UltraMinimal = () => {
  ...
  return (
    <main className="py-10 px-8 md:py-16 md:px-16 relative flex justify-center items-start min-h-screen">
      <div ref={contentRef} className="max-w-2xl w-full mx-auto space-y-8 pt-4 md:pt-8">
