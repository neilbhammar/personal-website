        ...
        <div className="flex-1 pt-24" ref={contentRef}>
          ...
          <section className="mb-20 py-16 max-w-4xl mx-auto px-6">
            ...
            <p className="text-lg text-gray-600 leading-relaxed max-w-2xl mb-8">
              This site is still a work in progress. I have no clue what it's going to be yet.
            </p>
            
            <div className="flex space-x-4 mt-8">
              <a href="#about" className="px-6 py-2 border border-gray-300 hover:border-gray-500 rounded-full transition-colors">
                Read More
              </a>
              
              <a href="mailto:bhammar.neil@gmail.com" className="px-6 py-2 bg-gray-800 text-white rounded-full hover:bg-gray-700 transition-colors">
                Get in Touch
              </a>
            </div>
          </section>
          ...
          <section id="about" className="py-16 mb-20">
            <div className="max-w-4xl mx-auto px-6">
              <h2 className="text-3xl font-normal mb-8 tracking-tight">About Me</h2>
              
              <div className="text-lg text-gray-700 leading-relaxed space-y-6">
                <p>
                  I spent the last 5.5 years building and scaling a company
                  (<a href="https://busright.com" target="_blank" rel="noopener noreferrer" className="text-blue-600 hover:underline">BusRight</a>) 
                  that was creating the software that powers our nation's largest mass transit system: school buses.
                </p>
                
                <p>
                  I joined as employee #1 before we had any customers or much of a product and recently wrapped up that chapter as our Head of Operations & Customer Experience following our Series B. I had a ton of fun.
                </p>
                
                <p>
                  Before that, I invested in and supported founders at <a href="#" className="text-blue-600 hover:underline">DormRoomFund</a> and Northeastern University.
                </p>
          ...
          <section id="work" className="py-16 mb-20 bg-gray-50">
            <div className="max-w-4xl mx-auto px-6">
              <h2 className="text-3xl font-normal mb-8 tracking-tight">Work Experience</h2>
              
              <div className="space-y-12">
                <div className="border-b border-gray-200 pb-8">
                  <div className="flex flex-wrap justify-between items-baseline mb-2">
                    <h3 className="text-xl font-medium">Head of Operations & Customer Experience</h3>
                    <span className="text-gray-500 text-sm">2019 - 2024</span>
                  </div>
                  <h4 className="text-gray-600 mb-4">BusRight</h4>
                  <p className="text-gray-700 leading-relaxed">
                    Led operations and customer experience for a growing SaaS company in the education transportation space.
                    Helped scale the company from 0 to 3M+ daily users across hundreds of school districts nationwide.
                  </p>
                </div>
                ...
                <div className="border-b border-gray-200 pb-8">
                  ...
                  <p className="text-gray-700 leading-relaxed">
                    Invested in and supported student-founded startups across the Boston ecosystem.
                  </p>
                </div>
              </div>
            </div>
          ...
          <section id="contact" className="py-16 mb-12">
            <div className="max-w-4xl mx-auto px-6 text-center">
              <h2 className="text-3xl font-normal mb-6 tracking-tight">Let's Connect</h2>
              
              <p className="text-lg text-gray-600 mb-8 max-w-xl mx-auto">
                You can connect with me on socials (I'm more of a lurker) or shoot me an email.
              </p>
